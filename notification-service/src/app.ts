...
import RedisSubscriber from './helpers/redis-sub';
...
@registry([
  ...
  { token: NotificationRepository, useClass: NotificationRepository },
...
export default class App {
  ...
  constructor(
    ...
    protected NotificationsRoute?: NotificationsRoute,
    ...
    this.initializeRoutes([NotificationsRoute]);
